...
*/}
      ...
      <nav className="sticky top-0 z-40 bg-slate-900 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
        <div
          ...
          style={{ fontFamily: '"Apple Color Emoji"', backgroundClip: "unset" }}
        >
      ...
      {/* shadcn/ui Card test and carousel item*/}
      ...
      <div id="agenda">
        <div className="card-container justify-center mx-auto py-8 px-4 md:mb-16">
          <div className="card">
            <img src="src/assets/freepik.jpg" alt="Card Image" />
            <div className="card-content">
              <h2>Card Title 1</h2>
              <p>
                This is a beautiful responsive card with smooth hover
                animations. Perfect for portfolios or UI sections.
              </p>
          ...
          <div className="card">
            <img src="src/assets/freepik2.jpg" alt="Card Image" />
            <div className="card-content">
              <h2>Card Title 2</h2>
              <p>
                This card scales on hover, the image zooms, and the button
                animates. Looks amazing on mobile too.
              </p>
              <button>Read More</button>
            </div>
          </div>
          ...
          <div className="card">
            <img src="src/assets/freepik3.jpg" alt="Card Image" />
            <div className="card-content">
              <h2>Card Title 3</h2>
              <p>
                Fully responsive, modern, and animated card. You can copy this
                structure for multiple cards.
              </p>
              <button>Read More</button>
            </div>
          </div>
        ...
        <div className="flex flex-wrap justify-center mx-auto py-8 px-4 md:mb-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="w-full sm:w-80 mb-4 rounded-lg bg-white shadow-lg ring-2 ring-transparent transition-colors hover:bg-blue-100 ">
              <img
                className="rounded-t-lg w-full h-48 sm:h-64 object-fill"
                src="src/assets/freepik.jpg"
                alt=""
              />
            ...
            <div className="w-full sm:w-80 mb-4 rounded-lg bg-white shadow-lg ring-2 ring-transparent transition-colors hover:bg-blue-100 ">
              ...
              <div className="py-4 px-6">
                ...
                <p className="hover:cursor-pointer py-2 text-gray-600 leading-5">
                  ...
                  Discover the magic of server-side programming and build
            ...
            <div className="w-full sm:w-80 mb-4 rounded-lg bg-white shadow-lg ring-2 ring-transparent transition-colors hover:bg-blue-100 ">
              ...
              <div className="py-4 px-6">
                ...
                <p className="hover:cursor-pointer py-2 text-gray-600 leading-5">
                  Front-end to back-end, APIs, development tools, and
                  optimization - Elevate your coding skills and become a
                  versatile web development maestro.
                </p>
              </div>
            </div>
          </div>
      ...
      <div id="review" className=" py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8 md:mt-16 md:mb-16">
          <h2 className="mb-16 text-center text-2xl font-bold text-gray-800 md:mb-12 lg:text-3xl">
          ...
          <div className="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">
            <div className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
              <div className="text-center text-gray-600">
                “The webinar on web development conducted by John was
                exceptional. He explained complex concepts in a simple and
                engaging manner. I learned a lot and feel more confident in my
                web development skills now.”
              </div>
            ...
            <div className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8 ">
              <div className="text-center text-gray-600">
                “I thoroughly enjoyed the webinar hosted by Michael. His
                expertise in web development is evident, and he shared valuable
                insights and tips. It was a great learning experience, and I
            ...
            <div className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
              <div className="text-center text-gray-600">
                ...
                for me. His knowledge and passion for the subject were
                inspiring. The practical examples and hands-on helped me improve
                my coding skills.”
              </div>
